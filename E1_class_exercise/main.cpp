...
void renderHUD(GameCharacter &hero) {
    ...
    // TODO if the hero has a weapon print its strength OK?
    if (hero.getWeapon() != nullptr) {
        std::cout << " - Strength: " << hero.getWeapon()->getStrength() << std::endl;
    }
    else {
        std::cout << std::endl;
    }
...
int main() {
    ...
    // TODO instantiate a static "hero" object of type GameCharacter with default parameters OK
    ...
    // TODO instantiate a static "sword" object of type Weapon with strenght=10 and no magic OK
    static Weapon sword(10, false);
    // TODO give the weapon to the hero OK
